/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv` (hash: e1aa54d7c23872e9d4726cf90f72bfce)
// Runtime types generated with workerd@1.20250823.0 2025-03-25 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		FLOWS_KV: KVNamespace;
		USERS_KV: KVNamespace;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		AUTH_DISCORD_ID: string;
		AUTH_DISCORD_SECRET: string;
		AUTH_ROBLOX_ID: string;
		AUTH_ROBLOX_SECRET: string;
		...
		OAUTH2_TOKEN_SIGN_KEY: string;
		OAUTH2_TOKEN_ENCRYPT_KEY: string;
		ASSETS: Fetcher;
	}
}
