...
ALTER TABLE `bcps-orylogin_oauth2_login_attempt` ALTER COLUMN "is_a_logout" TO "is_a_logout" integer NOT NULL DEFAULT false;--> statement-breakpoint
...
CREATE UNIQUE INDEX `bcps-orylogin_user_email_unique` ON `bcps-orylogin_user` (`email`);